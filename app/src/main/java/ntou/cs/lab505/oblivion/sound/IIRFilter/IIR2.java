package ntou.cs.lab505.oblivion.sound.IIRFilter;
...
import ntou.cs.lab505.oblivion.math.Complex;
...
public class IIR2 {
    ...
    public IIR2(int FilterOrder, int sampleRate, double Lcutoff, double Ucutoff)
    {
